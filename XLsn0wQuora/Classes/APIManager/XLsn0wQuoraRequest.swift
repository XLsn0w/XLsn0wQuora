 ...
 *     /\/\/\    | |        |_______ |   | |  \ \| |  | |     | |     \ \/ /   \ \/ /        *
 *    / /  \ \   | |______   ______| |   | |   \ \ |  | |_____| |      \ \/     \ \/         *
 *   /_/    \_\  |________| |________|   |_|    \__|  |_________|       \/       \/          *
 *                                                                                           *
 *********************************************************************************************/
import UIKit
import Alamofire
...
class XLsn0wQuoraRequest: NSObject {
    ...
    class func NetworkRequest(url:String,
                              requestName:String,
                              delegate:XLsn0wNetworkingDelegate,
                              param:NSDictionary? = nil,
                              method: HTTPMethod? = .get) {
        XLsn0wNetworking.requestDelegate(method: .get,
                                         url: url,
...
extension XLsn0wQuoraRequest {
    ...
    class func requestSplashImage(reqName:String, delegate:XLsn0wNetworkingDelegate) {
        ...
        NetworkRequest(url: curURL, requestName: reqName, delegate: delegate)
    }
