...
class QuoraGiftViewController: UIViewController {
//MARK： 属性列表
...
extension QuoraGiftViewController: UIScrollViewDelegate {
...
extension QuoraGiftViewController: PopoverClassifyViewDelegate {
