...
class QuoraLiveViewController: UIViewController, segmentBarTargetDelegate {
...
//                print(self.navModel.tabs[0].tab_title)
    ...
    fileprivate func setupNavigationTitleViewWithItems(array:[String]) {
        ...
        let childs = [controller2, controller3]
    ...
    private func setupNavigationItem() {
        self.navigationItem.leftBarButtonItem = UIBarButtonItem.creatBarItem(image: "ico_camera", highImage: "title_button_search", title: "", tagget: self, action: #selector(gobackLiving))
    }
...
//delegate
extension QuoraLiveViewController : UIScrollViewDelegate {
